Read 5 bytes from stdin into cells 28 to 32 and print them out (Linux aarch64 syscalls)

Cell 0: 63 = Syscall code for read on Linux aarch64
  ...
  ++++++++++
  ++++++++++
  +++ >      Syscall code 63 for read() on Linux aarch64
  +++ >      Arg count 3
